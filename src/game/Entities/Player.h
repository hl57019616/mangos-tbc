...
class Player : public Unit
{
    ...
    public:
        ...
        **/
        ...
        Item* EquipNewItem(uint16 pos, uint32 item, bool update, int32 suffixOverride = 0);
        ...
        bool IsFlying() const override { return m_movementInfo->HasMovementFlag(MOVEFLAG_FLYING); }
